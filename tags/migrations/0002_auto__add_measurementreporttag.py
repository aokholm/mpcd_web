...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MeasurementReportTag'
        db.create_table(u'tags_measurementreporttag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=60)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['tags.MeasurementReportTag'])),
            (u'lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            (u'rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            (u'tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            (u'level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal(u'tags', ['MeasurementReportTag'])


    def backwards(self, orm):
        # Deleting model 'MeasurementReportTag'
        db.delete_table(u'tags_measurementreporttag')
