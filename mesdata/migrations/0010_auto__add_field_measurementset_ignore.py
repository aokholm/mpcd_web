...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MeasurementSet.ignore'
        db.add_column(u'mesdata_measurementset', 'ignore',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MeasurementSet.ignore'
        db.delete_column(u'mesdata_measurementset', 'ignore')
