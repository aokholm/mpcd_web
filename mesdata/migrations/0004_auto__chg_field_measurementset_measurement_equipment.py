...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MeasurementSet.measurement_equipment'
        db.alter_column(u'mesdata_measurementset', 'measurement_equipment_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tags.MeasurementEquipment']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MeasurementSet.measurement_equipment'
        raise RuntimeError("Cannot reverse this migration. 'MeasurementSet.measurement_equipment' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'MeasurementSet.measurement_equipment'
        db.alter_column(u'mesdata_measurementset', 'measurement_equipment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tags.MeasurementEquipment']))
