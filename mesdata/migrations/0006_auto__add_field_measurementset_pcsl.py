...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MeasurementSet.pcsl'
        db.add_column(u'mesdata_measurementset', 'pcsl',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MeasurementSet.pcsl'
        db.delete_column(u'mesdata_measurementset', 'pcsl')
