...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MeasurementSet.measurement_number'
        db.alter_column(u'mesdata_measurementset', 'measurement_number', self.gf('django.db.models.fields.CharField')(max_length=24))

    def backwards(self, orm):

        # Changing field 'MeasurementSet.measurement_number'
        db.alter_column(u'mesdata_measurementset', 'measurement_number', self.gf('django.db.models.fields.CharField')(max_length=6))
