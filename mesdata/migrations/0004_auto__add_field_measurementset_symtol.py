...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MeasurementSet.symtol'
        db.add_column(u'mesdata_measurementset', 'symtol',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MeasurementSet.symtol'
        db.delete_column(u'mesdata_measurementset', 'symtol')
