...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MeasurementReport.measured'
        db.delete_column(u'mesdata_measurementreport', 'measured')


    def backwards(self, orm):
        # Adding field 'MeasurementReport.measured'
        db.add_column(u'mesdata_measurementreport', 'measured',
