...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('mesdata_measurementset', 'tol_up', 'usl')
        db.rename_column('mesdata_measurementset', 'tol_low', 'lsl')

    def backwards(self, orm):
        "Write your backwards methods here."
        db.rename_column('mesdata_measurementset', 'usl', 'tol_up')
        db.rename_column('mesdata_measurementset', 'lsl', 'tol_low')
