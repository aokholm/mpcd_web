...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field tags on 'MeasurementReport'
        m2m_table_name = db.shorten_name(u'mesdata_measurementreport_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('measurementreport', models.ForeignKey(orm[u'mesdata.measurementreport'], null=False)),
            ('measurementreporttag', models.ForeignKey(orm[u'tags.measurementreporttag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['measurementreport_id', 'measurementreporttag_id'])


    def backwards(self, orm):
        # Removing M2M table for field tags on 'MeasurementReport'
        db.delete_table(db.shorten_name(u'mesdata_measurementreport_tags'))
    ...
    models = {
        ...
        u'mesdata.measurementreport': {
            ...
            'generaltag': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'measurement_reports'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['tags.GeneralTag']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
