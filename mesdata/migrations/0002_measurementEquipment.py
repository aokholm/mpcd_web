...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('mesdata_measurementset', 'equipment_id', 'measurement_equipment_id')
        
    def backwards(self, orm):
        "Write your backwards methods here."
        db.rename_column('mesdata_measurementset', 'measurement_equipment_id', 'equipment_id')
