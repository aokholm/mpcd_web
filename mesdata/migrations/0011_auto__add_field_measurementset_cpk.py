...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MeasurementSet.cpk'
        db.add_column(u'mesdata_measurementset', 'cpk',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MeasurementSet.cpk'
        db.delete_column(u'mesdata_measurementset', 'cpk')
    ...
    models = {
        ...
        u'mesdata.measurementset': {
            ...
            'cpk': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
